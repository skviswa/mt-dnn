...
from data_utils.metrics import (
    compute_acc,
    compute_f1,
    compute_mcc,
    compute_pearson,
...
# RQE
RQELabelMapper = Vocabulary(True)
RQELabelMapper.add("false")
RQELabelMapper.add("true")

MediQAMapper = {"4": 1, "3": 1, "2": 0, "1": 0}
