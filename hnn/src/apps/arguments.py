...
def build_optimizer_args():
    ...
    parser.add_argument(
        "--qhadam_v1", default=1, type=float, help="The v1 parameter for QHAdam."
    )
    parser.add_argument(
        "--qhadam_v2", default=1, type=float, help="The v2 parameter for QHAdam."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--epsilon", default=1e-6, type=float, help="The epsilon parameter for Adam."
    )
    parser.add_argument(
        "--warmup_proportion",
        default=0.1,
...
def build_training_args():
    ...
    parser.add_argument(
        "--mask_ratio", type=float, default=0.1, help="The the ratio of masked tokens."
    )
    parser.add_argument(
        "--mask_keep_ratio",
        type=float,
    ...
    parser.add_argument(
        "--reset_ratio", type=float, default=0, help="The the ratio of weight reset."
    )
    parser.add_argument(
        "--init_spec",
        type=str,
...
def build_data_args():
    parser = argparse.ArgumentParser(
        description="Arguments for data cooking and inputs settings."
    )
    parser.add_argument(
        "--data_dir",
        default=None,
...
def build_app_args():
    ## Required parameters
    parser = argparse.ArgumentParser(
        description="Arguments for application running settings"
    )
    parser.add_argument(
        "--task_name",
        default=None,
    ...
    parser.add_argument(
        "--bert_config", type=str, help="The config file of bert model."
    )
    parser.add_argument("--vocab", type=str, help="The vocabulary file of bert model.")

    parser.add_argument(
        "--pool_config", type=str, default=None, help="The config file of pooling."
    )
